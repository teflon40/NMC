            ...
            <div className="space-y-4">
                {procedures.map((proc: any) => {
                    ...
                    */
                    ...
                    // In PracticalAssessment.tsx, scores are uploaded inside details.procedureScores and keyed by step
                    const stepKey = (proc as any).stepNumber ?? proc.step;
                    const score1 = (assessor1.details as any)?.procedureScores?.[stepKey] ?? 0;
                    const score2 = (assessor2.details as any)?.procedureScores?.[stepKey] ?? 0;
